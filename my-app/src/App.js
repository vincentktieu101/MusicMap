...
export default function App() {
  ...
  return (
    <div>
      ...
      {searchToggle && <SearchBar className="hidden" setSearchToggle={setSearchToggle} triggerAudioPlayer={triggerAudioPlayer} />}
      ...
      <div className={(aboutToggle || searchToggle) ? "audio-player hidden" : "audio-player"}>
        <AudioPlayerMenu
          activeGenreData={activeGenreData}
          audioPlayer={audioPlayer}
          shuffle={shuffle}
