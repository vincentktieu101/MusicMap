...
export default function SearchBar(props) {
  ...
  return (
    ...
    >
      ...
      <div style={{backgroundColor: "white", width: "80%", padding: "4px", margin: "4px" }}>
        <form onSubmit={(e) => {
          e.preventDefault();
          ...
          <Autocomplete
            ...
            renderInput={(params) => <TextField {...params} style={{backgroundColor: "white", marginRight: "4px", padding: "4px", fontSize: "32px"}} label="Genre" onChange={(e) => {setSearchValue(e.target.value)}} />}
          />
        </form>
      </div>
    </div>
